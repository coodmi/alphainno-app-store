...
export default function SignupPage() {
  ...
  // Step 1: Submit form → send OTP automatically
  ...
  // Step 2: Verify OTP → create account → redirect to login
  const handleOtpSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createAccount({ email, password, name, username: name.toLowerCase().replace(/\s+/g, "_") });
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
            ...
            {step === "form" && (
              <>
                ...
                <p className="text-gray-600 mb-6 text-sm">Fill in your details to get started</p>
                ...
                <form onSubmit={handleFormSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full bg-blue-600 text-white py-2.5 rounded-lg font-medium hover:bg-blue-700 transition mt-2 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                  >
                    {isLoading ? "Sending code..." : <> Create Account <ArrowRight className="w-4 h-4" /> </>}
                  </button>
                </form>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative text-white max-w-lg z-10">
          ...
          <p className="text-lg text-blue-100 mb-8">
            Create your account in seconds with email verification. No hassle, just secure access.
          </p>
